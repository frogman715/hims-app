          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 overflow-hidden">
            ...
            <ul className="divide-y divide-gray-200">
              {recruitments.map((recruitment) => (
                <li key={recruitment.id} className="hover:bg-gray-50/50 transition-colors duration-200">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center">
                          ...
                          <p className="ml-3 text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded-full">
            ...
            {recruitments.length === 0 && (
              <div className="px-6 py-12 text-center">
                ...
                <Link
                  href="/hr/recruitment/new"
                  className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 shadow-lg hover:shadow-xl inline-block"
                >
                  Add First Candidate
                </Link>
              </div>

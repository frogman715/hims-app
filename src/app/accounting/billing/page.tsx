        ...
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg text-gray-600 mt-2 font-medium">Generate invoices and track payments from principals</p>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                + Create Invoice
              </button>
            </div>

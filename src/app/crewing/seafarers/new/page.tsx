        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-300">
            ...
            <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div className="flex items-center gap-4">
                <div className="relative w-20 h-20 bg-gray-100 rounded-lg border-2 border-dashed border-gray-300 overflow-hidden flex items-center justify-center">
                  {formData.photoUrl ? (
                    <Image src={formData.photoUrl} alt="Preview" width={80} height={80} className="object-cover" />
                  ) : (
                ...
                <div>
                  <input
                    ...
                    className="hidden"
                  />
                  <label htmlFor="photo" className="inline-block px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 cursor-pointer transition">
                    Choose Photo
                  </label>

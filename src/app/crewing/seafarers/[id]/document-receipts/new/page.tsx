        ...
        <form onSubmit={submitReceipt} className="bg-white shadow-xl rounded-2xl p-8 space-y-10">
          ...
          <section>
            ...
            {formData.crewStatus === 'EX_CREW' && (
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Tanggal Turun Kapal</label>
                  <input
                    type="date"
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Tanggal Penyerahan</label>
                <input
                  type="date"

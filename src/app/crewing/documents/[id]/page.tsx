        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50 p-8">
            ...
            <div className="print-only text-center mb-8 pb-4 border-b-2 border-gray-300">
              <h1 className="text-3xl font-bold text-gray-800 mb-2">HANMARINE SHIPPING</h1>
              <p className="text-lg text-gray-600">Document Management System</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Action Buttons */}
              <div className="flex gap-4 pt-6 border-t border-gray-200 no-print">
                <button
                  type="submit"
                  disabled={loading}
                  className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  Delete Document
                </button>
              </div>
            ...
            {/* Print Footer */}
            <div className="print-only text-center mt-8 pt-4 border-t-2 border-gray-300">
              <p className="text-sm text-gray-500">This document was generated from the Hanmarine HIMS system</p>
              <p className="text-xs text-gray-400 mt-1">Document ID: {id} | Seafarer: {document?.seafarer.fullName}</p>
            </div>
          </div>
        </div>
      </main>

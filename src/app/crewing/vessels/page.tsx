    ...
    <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600">Manage fleet vessels</p>
            </div>
          </div>
          <button
      ...
      {showForm && (
        <div className="bg-gradient-to-r from-white/90 to-blue-50/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8 mb-8">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">🚢 Add New Vessel</h2>
            <p className="text-gray-600">Register vessel information and specifications</p>
          </div>
      ...
      <div className="bg-gradient-to-r from-white/90 to-gray-50/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 overflow-hidden">
        <div className="px-8 py-6 border-b border-gray-200">
          <h2 className="text-xl font-bold text-gray-900">All Vessels</h2>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="p-8 text-center">
            <p className="text-gray-600">No vessels found. Add your first vessel above.</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-8 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Vessel Name</th>
                  <th className="px-8 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Principal</th>
                  <th className="px-8 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Crew On Board</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {vessels.map((vessel: Vessel) => (
                  <tr key={vessel.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-8 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-600">{vessel.principal?.name}</div>
                    </td>
                    <td className="px-8 py-4 whitespace-nowrap">

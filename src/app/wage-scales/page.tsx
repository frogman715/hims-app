    ...
    <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600">Manage standard wage scales for different vessel types and ranks</p>
            </div>
          </div>
          <button
      ...
      {showForm && (
        <div className="bg-gradient-to-r from-white/90 to-blue-50/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8 mb-8">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">{editingScale ? 'Edit Wage Scale' : 'Add New Wage Scale'}</h2>
            <p className="text-gray-600">Set standard wages for seafarers based on vessel type and rank</p>
          </div>
      ...
      <div className="bg-gradient-to-r from-white/90 to-gray-50/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 overflow-hidden">
        <div className="px-8 py-6 border-b border-gray-200">
          <h2 className="text-xl font-bold text-gray-900">Standard Wage Scales</h2>
        </div>

        {isLoading ? (
          <div className="p-8 text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto"></div>
            <p className="mt-4 text-gray-600">Loading wage scales...</p>
          </div>
        ) : wageScales.length === 0 ? (
          <div className="p-8 text-center">
            <p className="text-gray-600">No wage scales found. Create your first wage scale above.</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-8 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Vessel Type</th>
                  <th className="px-8 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Rank</th>
                  <th className="px-8 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Basic Wage</th>
                  <th className="px-8 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Monthly Total</th>
                  <th className="px-8 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Effective</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {wageScales.map((scale) => (
                  <tr key={scale.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-8 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-600">{scale.rank.replace('_', ' ')}</div>
                    </td>
                    <td className="px-8 py-4 whitespace-nowrap">

  ...
  return (
    <div className="section-stack">
      <WorkspaceHero
        ...
        title="PT. HANN GLOBAL INDONESIA"
        subtitle="HANMARINE Integrated Management System. ISO 9001:2015 and MLC 2006 aligned operating platform for crewing, compliance, quality, and administrative control."
        highlights={[
          { label: "Management Standard", value: "ISO 9001:2015", detail: "Quality management framework referenced by the platform." },
          { label: "Labour Framework", value: "MLC 2006", detail: "Maritime labour obligations built into operational workflows." },
          { label: "Training Standard", value: "STCW 2010", detail: "Competence and certification alignment for seafarer management." },
          { label: "Safety Code", value: "ISM Code", detail: "Safety management discipline reflected across compliance workflows." },
        ]}
        helperLinks={[
...
• Establish long-term partnerships with reputable ship owners and principals`}
        ...
        {/* Compliance Badges */}
        <div className="rounded-[2rem] border border-slate-200 bg-[linear-gradient(135deg,#0f172a_0%,#164e63_54%,#155e75_100%)] p-8 text-white shadow-sm">

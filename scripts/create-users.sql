...
VALUES
  ...
  ('clxuser003arief', 'arief@hanmarine.co', 'Arief Setiawan (Operational)', 'OPERATIONAL', '$2b$10$uO.30AbZqkAKJeRKFQDGnezXnsev/Ni5qArT8H88NQuCG2Jyrd8AW', NOW(), NOW()),
  ('clxuser004dino', 'dino@hanmarine.co', 'Dino Prasetyo (Accounting)', 'ACCOUNTING', '$2b$10$uO.30AbZqkAKJeRKFQDGnezXnsev/Ni5qArT8H88NQuCG2Jyrd8AW', NOW(), NOW()),
  ('clxuser005rizkie', 'rizkie@hanmarine.co', 'Rizkie (Document Control)', 'CDMO', '$2b$10$uO.30AbZqkAKJeRKFQDGnezXnsev/Ni5qArT8H88NQuCG2Jyrd8AW', NOW(), NOW()),
  ('clxuser006imron', 'imron@hanmarine.co', 'Imron (GA Driver)', 'GA_DRIVER', '$2b$10$uO.30AbZqkAKJeRKFQDGnezXnsev/Ni5qArT8H88NQuCG2Jyrd8AW', NOW(), NOW()),
